	...
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			...
			<?php
				...
				echo "<tr>";
				echo "<td class=\"fix_table\">Price :</td>";
			...
			<table cellpadding="5" style='margin-left: 50px'>
				...
				<tr>
					<td class="fix_table"> Dana <input type="radio" name="payment_mode" value="credit card" checked></td>
					<td class="fix_table"> BNI <input type="radio" name="payment_mode" value="debit card"></td>
					<td class="fix_table"> Mandiri <input type="radio" name="payment_mode" value="net banking"></td>
				</tr>
			</table>
			<br>
